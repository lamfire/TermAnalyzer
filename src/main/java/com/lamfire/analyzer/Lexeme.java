...
public final class Lexeme implements Comparable<Lexeme>{
	...
	//姓氏
	public static final int TYPE_CJK_SURNAME = 1;
	//尾缀
	public static final int TYPE_CJK_SIFFIX = 2;
	//未知的
	...
	public String getLexemeTypeName(){
		...
		case TYPE_CJK_NORMAL : 
			return ("NORMAL");
		case TYPE_CJK_SIFFIX :
			return ("SUFFIX");
		case TYPE_CJK_SURNAME :
			return ("SURNAME");
	 ...
	 * @return Lexeme
	 */
	public static Lexeme buildLexeme(char[] segmentBuff,int offset , int begin , int length , int lexemeType) {
		Lexeme newLexeme = new Lexeme(offset , begin ,length,lexemeType);
		newLexeme.setLexemeText(String.valueOf(segmentBuff,begin, length));
		return newLexeme;
	}
}