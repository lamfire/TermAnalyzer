 ...
 *
 */
public class QuantifierSeg implements Seg {
...
//		AllNumberChars.addAll(RomeNumChars);
	 ...
	 * @param context
	 */
	private void processNumber(char[] segmentBuff , SegContext context){
		//数词字符识别
...
//			onROMEStatus(inputStatus , context);			
	 ...
	 * @param context
	 */
	private void onNaNStatus(int inputStatus ,  SegContext context){
		if(NaN == inputStatus){
			return;
...
//			nEnd = context.getCursor();	
	 ...
	 * @param context
	 */
//	private void onANPStatus(int inputStatus ,  SegContext context){
...
//	}
	 ...
	 * @param context
	 */
	private void onARABICStatus(int inputStatus ,  SegContext context){
		if(NC_ARABIC == inputStatus){//阿拉伯数字
			//保持状态不变
			//记录可能的结束位置
			nEnd = context.getCursor();
...
//			nReset();
	 ...
	 * @param context
	 */
	private void onANMStatus(int inputStatus ,  SegContext context){
		if (NC_ARABIC == inputStatus){//阿拉伯数字
			//记录当前的字符状态
			nStatus = inputStatus;
			//记录可能的结束位置
...
//			nStatus = inputStatus;
	 ...
	 * @param context
	 */
//	private void onANEStatus(int inputStatus ,  SegContext context){
//		//输出可能存在的数词
//		outputNumLexeme(context);
//		//重置数词状态
//		nReset();
...
//	}	
	 ...
	 * @param context
	 */
	private void onNPStatus(int inputStatus ,  SegContext context){
...
//			onNaNStatus(inputStatus , context);	
	 ...
	 * @param context
	 */
	private void onCHINESEStatus(int inputStatus ,  SegContext context){
		if(NC_CHINESE == inputStatus){//中文数字
			//记录可能的结束位置
			nEnd = context.getCursor();
	 ...
	 * @param context
	 */
	private void onCNMStatus(int inputStatus ,  SegContext context){
		if(NC_CHINESE == inputStatus){//中文数字
			//记录当前的字符状态
			nStatus = inputStatus;
			//记录可能的结束位置
	 ...
	 * @param context
	 */
	private void onCNEStatus(int inputStatus ,  SegContext context){
		//输出可能存在的数词
		outputNumLexeme(context);
		//重置数词状态
		nReset();
	 ...
	 * @param context
	 */
//	private void onROMEStatus(int inputStatus ,  SegContext context){
...
//	}
	 ...
	 * @param context
	 */
	private void outputNumLexeme(SegContext context){
		if(nStart > -1 && nEnd > -1){
			//生成已切分的词元
	 ...
	 * @param context
	 */
	private void outputCountLexeme(SegContext context){
	 ...
	 * @return
	 */
	private int nIdentify(char[] segmentBuff , SegContext context){
		...
		if(CharHelper.isArabicNumber(input)){
			type = NC_ARABIC;
...
//			type = NC_ROME;
	 ...
	 * @param context
	 */
	private void processCount(char[] segmentBuff , SegContext context){
		Hit hit = null;
